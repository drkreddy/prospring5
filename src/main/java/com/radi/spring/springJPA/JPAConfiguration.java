...
@ComponentScan(basePackages = "com.radi.spring.springJPA")
public class JPAConfiguration {
    ...
    public EntityManagerFactory entityManagerFactory(){
        ...
        factoryBean.setPackagesToScan("com.radi.spring.springJPA");
    ...
    public static void main(String[] args) {
        ...
        Singer byName = singerService.findByName(all1.get(1).getFirstName());
        System.out.println("Singer Fetched By Name");
